...
5. **严禁**随意编造测试数据，如URL、测试账号等

## 执行流程

### Step 1：加载输入材料
读取：
- `prd/{feature-dir}/output/{feature-name}-analysis.md`
- `prd/{feature-dir}/output/{feature-name}-clarifications.md`, 若澄清问题清单内还有未确认的问题，优先询问用户是否忽略未澄清的问题
